...
public partial class StateMachineTemplate : Node
{
	TransitionEvent dummyTransitionEvent = new();
	...
	{
		EventManager.Listen<TransitionEvent>(dummyTransitionEvent, Transition);
